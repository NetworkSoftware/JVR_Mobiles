...
import pro.network.jvrmobiles.chip.ChipAdapter;
import pro.network.jvrmobiles.chip.ChipBean;
import pro.network.jvrmobiles.chip.OnChip;
import pro.network.jvrmobiles.product.ProductActivity;
import pro.network.jvrmobiles.product.ProductItemClick;
import pro.network.jvrmobiles.product.ProductListAdapter;
...
public class AllProductActivity extends BaseActivity implements ProductItemClick, OnChip {
    ...
    protected void startDemo() {
        ...
        db = new DatabaseHelperJVR(getApplicationContext());
    ...
    private void fetchProductList(final String searchKey) {
        ...
        StringRequest strReq = new StringRequest(Request.Method.GET,
                AppConfig.PRODUCT_GET_ALL +"?SearchKey"+productList+("?category"+productList), new Response.Listener<String>() {
            @Override
