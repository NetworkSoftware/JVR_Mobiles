package pro.network.jvrmobiles.ad;
...
public class ActivityMediaOnline extends AppCompatActivity {
    ...
    private void previewMedia(boolean paramBoolean) {
        ...
        if (paramBoolean) {
            ...
            Glide.with(ActivityMediaOnline.this).
                    load(filePath).apply(new RequestOptions().placeholder(R.drawable.jvrlogo))
                    .into(imgPreview);
    ...
    protected void onCreate(@Nullable Bundle paramBundle) {
        ...
        if (this.filePath != null) {
            ...
            getSupportActionBar().setTitle("JVR Mobiles");
