...
import pro.network.jvrmobiles.ad.AdimgAdapter;
import pro.network.jvrmobiles.app.AppConfig;
import pro.network.jvrmobiles.app.AppController;
import pro.network.jvrmobiles.product.AllOffersAdapter;
import pro.network.jvrmobiles.product.BannerActivity;
