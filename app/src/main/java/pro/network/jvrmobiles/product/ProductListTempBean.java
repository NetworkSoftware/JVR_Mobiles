...
public class ProductListTempBean implements Serializable {
    ...
    public ProductListTempBean(String userId, String cart, String brand, String name, String rom, String ram,
                               String price, String model, ArrayList<String> image, String description, String qty) {
        this.userId = userId;
        this.cart = cart;
        this.brand = brand;
        this.name = name;
