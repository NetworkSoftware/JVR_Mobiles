...
public class ProductListBean implements Serializable {
    public static final String TABLE_NAME = "yalu_Mobiles";
    public static final String TABLE_NAME_WISH = "yaluWish";
    ...
    public ProductListBean(String userId, String cart, String wish, String brand, String name, String rom, String ram, String price, String model, String image, String description, String qty, String stock_update) {
        this.userId = userId;
        this.cart = cart;
        this.wish = wish;
        this.brand = brand;
