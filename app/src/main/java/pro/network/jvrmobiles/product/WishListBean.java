...
public class WishListBean implements Serializable {
    ...
    public WishListBean(String userId, String cart, String brand, String name, String rom, String ram, String price, String model, String image, String description, String qty, String stock_update) {
        this.userId = userId;
        this.cart = cart;
        this.brand = brand;
        this.name = name;
