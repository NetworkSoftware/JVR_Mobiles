...
import pro.network.jvrmobiles.ChangePassword;
import pro.network.jvrmobiles.FeedbackMainbean;
...
import pro.network.jvrmobiles.app.BaseFragment;
...
import static pro.network.jvrmobiles.app.AppConfig.FEEDBACk_CREATE;
...
import static pro.network.jvrmobiles.app.AppConfig.user_phone;
import static pro.network.jvrmobiles.app.AppConfig.usernameKey;
...
public class AboutusActivity extends BaseFragment implements OnAboutListener {
    ...
    protected View startDemo(LayoutInflater inflater, ViewGroup container) {
        ...
        dbHelper = new DatabaseHelperJVR(getActivity());
